...
class BashExecutor(Tools):
    ...
    Based on AgenticSeek's BashInterpreter with safety checks and error handling.
    """
    ...
    def __init__(self):
        ...
        self.description = "Executes bash/shell commands safely in the work directory"
    ...
    def execute(self, blocks: list, safety: bool = False) -> str:
        ...
        for i, block in enumerate(blocks):
            ...
            try:
                ...
                # Handle case where command runs but produces no output
